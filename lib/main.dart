    ...
    return Consumer<AuthProvider>(
      ...
      builder: (context, provider,child) {
        ...
        return MaterialApp(
            ...
            AppTheme.getDarkModeTheme():AppTheme.getLightModeTheme(),
  ...
  static ThemeData getLightModeTheme(){
    ...
    return ThemeData(
          ...
          scaffoldBackgroundColor: const Color(0xffF4F2F3),
            ...
            elevation: 05,
            backgroundColor: Colors.white,headerBackgroundColor: Colors.blue,
       yearBackgroundColor: MaterialStateProperty.all(Colors.white.withOpacity(0.2)),
headerForegroundColor:Colors.white,
dayOverlayColor:  MaterialStateProperty.all(Colors.blue),
dayBackgroundColor:  MaterialStateProperty.all(Colors.blue.withOpacity(0.3)),
cancelButtonStyle: ButtonStyle(backgroundColor: MaterialStateProperty.all(Colors.red),foregroundColor: MaterialStateProperty.all(Colors.white), ),
confirmButtonStyle: ButtonStyle(backgroundColor: MaterialStateProperty.all(Colors.green),foregroundColor: MaterialStateProperty.all(Colors.white),),
          ),
