...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //     style: ElevatedButton.styleFrom(backgroundColor:Theme.of(context).primaryColor,shadowColor: Colors.grey.withOpacity(0.5) ),
      //     onPressed: () {
      ...
      //       }
      //     },
      //     child:  Text("login",style: Theme.of(context).textTheme.bodyLarge!.copyWith(fontSize: 25,color: Colors.white,fontWeight: FontWeight.bold)),
      //   ),
      // ),
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Stack(
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    right: width * 0.06,
                    child: Container(
                      height: MediaQuery.of(context).size.width * 1.3, // Adjust as needed
              ...
              Padding(
                padding:  EdgeInsets.only( left: 25, top: hight*0.47),
