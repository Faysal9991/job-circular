        ...
        children: [
          ...
          Padding(
            ...
            child: SizedBox(
              width: width * 1,
              child: Text(
                "yuybvcsvhs dsbvsv iugviubgwv sibv iuswbgv iubgsvwiubs j visuabvjsab viubaiv  jbv",
...
Widget roundContainer(BuildContext context, String text) {
  return Container(
    decoration: BoxDecoration(
